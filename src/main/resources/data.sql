...
VALUES
    (1003, 'Villa Rica', '3 BHK independent house with lawn and pool', 'Residential', 'Inactive', 'No', 1001, 1003),
    (1004, 'Palm Plaza', '4 BHK duplex apartment with garden and gym', 'Commercial', 'Active', 'Yes', 1002, 1004),
    (1005, 'Ocean View', '5 BHK villa with ocean view and private beach', 'Residential', 'Active', 'Yes', 1002, 1005);
